...
public final class CVCalendarMenuView: UIView {
    ...
    public var firstWeekday: Weekday! = UserDefaults.standard.bool(forKey: "weekStartFromMon") ? .monday : .sunday
    ...
    public var dayOfWeekFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getFootnote() : UIFont.systemFont(ofSize: 10, weight: .bold)
