...
public final class CVCalendarViewAppearance: NSObject {
    ...
    public var dayLabelWeekdayFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelPresentWeekdayFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelPresentWeekdayBoldFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelPresentWeekdayHighlightedFont: UIFont? =
    UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelPresentWeekdaySelectedFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelWeekdayHighlightedFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
    public var dayLabelWeekdaySelectedFont: UIFont? = UserDefaults.standard.bool(forKey: "useSmiley") ? SmileyFontSize.getNormal() : UIFont.systemFont(ofSize: 17, weight: .bold)
