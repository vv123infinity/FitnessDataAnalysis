...
//        let window = UIWindow()
        if UserDefaults.standard.bool(forKey: "useSmiley") {
            ...
            UIBarButtonItem.appearance().setTitleTextAttributes([NSAttributedString.Key.foregroundColor:  ColorUtil.getBarBtnColor(), NSAttributedString.Key.font : SmileyFontSize.getNormal()], for: .highlighted)
            UIBarButtonItem.appearance().setTitleTextAttributes([NSAttributedString.Key.foregroundColor:  ColorUtil.getBarBtnColor(), NSAttributedString.Key.font : SmileyFontSize.getNormal()], for: .focused)
...
//        let bounds = UIScreen.main.bounds
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "FitnessDataAnalysis")
